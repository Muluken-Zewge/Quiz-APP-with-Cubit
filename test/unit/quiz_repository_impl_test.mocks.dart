...
// in quiz_app_with_cubit/test/unit/quiz_repository_impl_test.dart.
...
class MockQuizRemoteDatasource extends _i1.Mock
  ...
  @override
  _i3.Future<List<_i4.QuizModel>> fetchQuiz(
    String? category,
    String? difficulty,
    int? numberOfQusetions,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i3.Future<List<_i4.QuizModel>>.value(<_i4.QuizModel>[]),
      ) as _i3.Future<List<_i4.QuizModel>>);
}
